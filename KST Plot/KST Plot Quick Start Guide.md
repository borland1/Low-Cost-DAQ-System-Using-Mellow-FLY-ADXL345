...
And tab 'View 2', with the Power Spectral Density (PSD) plots.

<img width="1174" height="727" alt="image" src="https://github.com/user-attachments/assets/92558e6d-664c-4c17-ac35-78e0ab711462" />

You can then explore the data using the Zoom features to zoom in on random events. In this case, high g-force (6+ g) on the z-axis channel.
